...
func (m *MockICompanyRepository) Create(arg0 context.Context, arg1 *domain.Company) (*domain.Company, error) {
	m.ctrl.T.Helper()
...
// Create mocks base method.
func (m *MockICompanyService) Create(arg0 context.Context, arg1 *domain.Company) (*domain.Company, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", arg0, arg1)
	ret0, _ := ret[0].(*domain.Company)
	ret1, _ := ret[1].(error)
