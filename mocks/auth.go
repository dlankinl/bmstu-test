...
func (m *MockIAuthRepository) Register(arg0 context.Context, arg1 *domain.UserAuth) (uuid.UUID, error) {
	m.ctrl.T.Helper()
...
// Register mocks base method.
func (m *MockIAuthService) Register(arg0 context.Context, arg1 *domain.UserAuth) (uuid.UUID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Register", arg0, arg1)
	ret0, _ := ret[0].(uuid.UUID)
	ret1, _ := ret[1].(error)
